...
- **`/peligros` es SOLO exposición** (ADR-A17). La frecuencia de emergencias es el otro eje —lo ocurrido, por distrito, con 21 tipos de evento frente a 9 peligros y taxonomías que no se convierten— y se retiró de esa página; su modelo, importador, endpoints, export, comparador y PDF siguen intactos. No reintroducirla ahí sin pedido explícito del usuario, que decidirá dónde va.

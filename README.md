...
| El admin y el flujo editorial | entrar, crear una noticia y publicarla (ADR-P3: sin paso de revisión) | credenciales, permisos y avisos por correo (van a `logs -f worker`) |
